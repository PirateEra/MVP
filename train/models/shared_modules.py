...
class SharedModel(pl.LightningModule):
    def __init__(self, args):
        ...
        """
        elif 'bart' in self.args.base_model:
            self.tokenizer = BartTokenizer.from_pretrained(self.args.base_model, legacy=False)
        else:
    ...
    def configure_optimizers(self):
        ...
        warmup_ratio = float(self.args.warmup_steps) / 100
